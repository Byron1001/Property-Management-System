...
public class Resident_Tenant_Management_Dialog extends JDialog{
    final int WIDTH = 500;
    final int HEIGHT  = 300;
    private ActionDoneListener listener;
    public Resident_Tenant_Management_Dialog(JFrame jf, String title, boolean isModel, ActionDoneListener listener){
